...
public class CuController {
    ...
    @GetMapping("/api/cu/{category}")
    public List<Product> getProductsByCategory(@PathVariable String category) {
        return cuService.viewCu(category);
    }
    ...
    @GetMapping("/home/event/cuEvent")
    public String cuEvent(Model model) {
        List<Product> products = cuService.viewCuEvent();
        model.addAttribute("products", products);
        return "home/event/cuEvent";
    }
